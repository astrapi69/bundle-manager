package de.alpharogroup.bundle.manager.application;
...
import de.alpharogroup.bundle.manager.pages.area.publicly.home.HomePage;
...
{
	public static final int DEFAULT_HTTP_PORT = 28080;
	public static final int DEFAULT_HTTPS_PORT = 28443;
	/** The Constant logger. */
